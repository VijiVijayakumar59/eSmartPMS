...
class ClosedDealsScreen extends StatefulWidget {
  const ClosedDealsScreen({super.key});

  @override
  State<ClosedDealsScreen> createState() => _ClosedDealsWidgetState();
}

class _ClosedDealsWidgetState extends State<ClosedDealsScreen> {
