...
class ExpiredDealsScreen extends StatefulWidget {
  const ExpiredDealsScreen({super.key});

  @override
  State<ExpiredDealsScreen> createState() => _ExpiredDealsWidgetState();
}

class _ExpiredDealsWidgetState extends State<ExpiredDealsScreen> {
