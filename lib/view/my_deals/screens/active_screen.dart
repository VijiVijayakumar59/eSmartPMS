...
class ActiveDealsScreen extends StatefulWidget {
  const ActiveDealsScreen({super.key});

  @override
  State<ActiveDealsScreen> createState() => _ActiveDealsWidgetState();
}

class _ActiveDealsWidgetState extends State<ActiveDealsScreen> {
